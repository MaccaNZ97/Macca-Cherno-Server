...
#include "$CurrentDir:\\mpmissions\\expansion.chernarusplus\\SurvivorMissionModule\\EventsWorldData.c"
#include "$CurrentDir:\\mpmissions\\expansion.chernarusplus\\SurvivorMissionModule\\Missions\\Missions.h"
